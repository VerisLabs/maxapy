...
/// Polygon Convex contract(booster.sol) basic interface
interface IConvexBoosterPolygon {
    /// Deposit into convex, receive a tokenized deposit.  parameter to stake immediately
    ...
    function poolInfo(uint256 _pid)
        external
        view
        returns (address _lptoken, address _gauge, address _crvRewards, bool _shutdown, address _factory);
}
