...
/// @author MaxApy
/// @notice `BaseConvexStrategyPolygon` sets the base functionality to be implemented by MaxApy Convex strategies.
/// @dev Some functions can be overriden if needed
abstract contract BaseConvexStrategyPolygon is BaseStrategy {
    ...
    IConvexRewardsPolygon public convexRewardPool;
    ...
    {
        // Cache reward pool
        IConvexRewardsPolygon rewardPool = convexRewardPool;
