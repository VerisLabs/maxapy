...
import { _1_WETH } from "test/helpers/Tokens.sol";
...
contract HopETHStrategyTest is BaseTest, ConvexdETHFrxETHStrategyEvents {
    ...
    function testHopETH__Initialization() public {
        ...
        assertEq(_strategy.strategyName(), bytes32(abi.encode("MaxApy WETH Strategy")));
    ...
    function testHopETH__PreviewLiquidate() public {
        ...
        assertApproxEq(expected, 30 * _1_WETH - loss, 15 * _1_WETH / 1000);
    }
