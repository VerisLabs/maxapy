...
import { YearnAaveV3WETHLenderStrategyWrapper } from "../../mock/YearnAaveV3WETHLenderStrategyWrapper.sol";
import { MaxApyVault } from "src/MaxApyVault.sol";
import { StrategyData } from "src/helpers/VaultTypes.sol";
import { StrategyEvents } from "../../helpers/StrategyEvents.sol";
import "src/helpers/AddressBook.sol";

contract YearnAaveV3WETHLenderStrategyTest is BaseTest, StrategyEvents {
    address public constant YVAULT_WETH_MAINNET = YEARN_AAVEv3_WETH_LENDER_YVAULT_MAINNET;
    address public TREASURY;

    IStrategyWrapper public strategy;
    YearnAaveV3WETHLenderStrategyWrapper public implementation;
    ...
    function setUp() public {
        ...
        implementation = new YearnAaveV3WETHLenderStrategyWrapper();
        ...
        vm.label(address(proxy), "YearnAaveV3WETHLenderStrategy");
    ...
    function testYearnAaveV3WETHLender__Initialization() public {
        ...
        YearnAaveV3WETHLenderStrategyWrapper _implementation = new YearnAaveV3WETHLenderStrategyWrapper();
    ...
    function testYearnAaveV3WETHLender__SetEmergencyExit() public {
        vm.stopPrank();
    ...
    function testYearnAaveV3WETHLender__SetMinSingleTrade() public {
        vm.stopPrank();
        vm.startPrank(users.bob);
        vm.expectRevert(abi.encodeWithSignature("Unauthorized()"));
    ...
    function testYearnAaveV3WETHLender__IsActive() public {
    ...
    function testYearnAaveV3WETHLender__SetStrategist() public {
        // Negatives
        vm.startPrank(users.bob);
        vm.expectRevert(abi.encodeWithSignature("Unauthorized()"));
    ...
    function testYearnAaveV3WETHLender__InvestmentSlippage() public {
    ...
    function testYearnAaveV3WETHLender__PrepareReturn() public {
    ...
    function testYearnAaveV3WETHLender__AdjustPosition() public {
    ...
    function testYearnAaveV3WETHLender__Invest() public {
    ...
    function testYearnAaveV3WETHLender__Divest() public {
        deal({ token: WETH_MAINNET, to: address(strategy), give: 10 ether });
        uint256 expectedShares = strategy.sharesForAmount(10 ether);
        strategy.invest(10 ether, 0);
        assertEq(expectedShares, IERC20(YVAULT_WETH_MAINNET).balanceOf(address(strategy)));
    ...
    function testYearnAaveV3WETHLender__LiquidatePosition() public {
        deal({ token: WETH_MAINNET, to: address(strategy), give: 10 ether });
    ...
    function testYearnAaveV3WETHLender__LiquidateAllPositions() public {
        deal({ token: WETH_MAINNET, to: address(strategy), give: 10 ether });
        uint256 expectedShares = strategy.sharesForAmount(10 ether);
        strategy.invest(10 ether, 0);
        assertEq(expectedShares, IERC20(YVAULT_WETH_MAINNET).balanceOf(address(strategy)));
    ...
    function testYearnAaveV3WETHLender__Harvest() public {
        vm.expectRevert(abi.encodeWithSignature("Unauthorized()"));
        strategy.harvest(0, 0, address(0), block.timestamp);
    ...
    function testYearnAaveV3WETHLender__PreviewLiquidate() public {
        vault.addStrategy(address(strategy), 4000, type(uint72).max, 0, 0);
        vault.deposit(100 ether, users.alice);
        vm.startPrank(users.keeper);
        strategy.harvest(0, 0, address(0), block.timestamp);
    ...
    function testYearnAaveV3WETHLender__PreviewLiquidateExact() public {
        vault.addStrategy(address(strategy), 4000, type(uint72).max, 0, 0);
        vault.deposit(100 ether, users.alice);
        vm.startPrank(users.keeper);
        strategy.harvest(0, 0, address(0), block.timestamp);
    ...
    function testYearnAaveV3WETHLender__maxLiquidateExact() public {
        vault.addStrategy(address(strategy), 9000, type(uint72).max, 0, 0);
        vault.deposit(35 ether, users.alice);
        vm.startPrank(users.keeper);
        strategy.harvest(0, 0, address(0), block.timestamp);
        vm.stopPrank();
    ...
    function testYearnAaveV3WETHLender__MaxLiquidate() public {
        vault.addStrategy(address(strategy), 9000, type(uint72).max, 0, 0);
        vault.deposit(100 ether, users.alice);
        vm.startPrank(users.keeper);
        strategy.harvest(0, 0, address(0), block.timestamp);
    ...
    function testYearnAaveV3WETHLender__SimulateHarvest() public {
        vault.addStrategy(address(strategy), 4000, type(uint72).max, 0, 0);
        vault.deposit(100 ether, users.alice);
