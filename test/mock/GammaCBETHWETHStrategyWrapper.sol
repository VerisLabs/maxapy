...
import { GammaCBETHWETHStrategy, SafeTransferLib } from "src/strategies/polygon/WETH/gamma/GammaCBETHWETHStrategy.sol";

contract GammaCBETHWETHStrategyWrapper is GammaCBETHWETHStrategy {
