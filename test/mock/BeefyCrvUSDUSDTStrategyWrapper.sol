...
import {
    BeefyCrvUSDUSDTStrategy, SafeTransferLib
} from "src/strategies/polygon/USDCe/beefy/BeefyCrvUSDUSDTStrategy.sol";

contract BeefyCrvUSDUSDTStrategyWrapper is BeefyCrvUSDUSDTStrategy {
