...
contract PolygonDeploymentScript is Script, OwnableRoles {
    ...
    // IStrategy public strategy6;  // YearnV3 - USDT                | YearnUSDTStrategy
    // IStrategy public strategy7;  // YearnV3 - DAI                 | YearnDAIStrategy
    // IStrategy public strategy8;  // YearnV3 - Aave V3 DAI Lender  | YearnDAILenderStrategy
    // IStrategy public strategy9;  // Beefy - MAI/USDC.e            | BeefyMaiUSDCeStrategy
    // IStrategy public strategy10; // Convex - crvUSD+USDC.e        | ConvexUSDCCrvUSDStrategy
    // IStrategy public strategy11; // Convex - crvUSD+USDT          | ConvexUSDTCrvUSDStrategy
    ...
    function run() public {
        ...
        // // Strategy7(YearnV3 - DAI)
        // YearnDAIStrategy implementation7 = new YearnDAIStrategy();
        // _proxy = new TransparentUpgradeableProxy(
        ...
        // // Strategy8(YearnV3 - Aave V3 DAI Lender)
        // YearnDAILenderStrategy implementation8 = new YearnDAILenderStrategy();
        // _proxy = new TransparentUpgradeableProxy(
        ...
        //  // Strategy9(BeefyMaiUSDCeStrategy)
        // BeefyMaiUSDCeStrategy implementation9 = new BeefyMaiUSDCeStrategy();
        // _proxy = new TransparentUpgradeableProxy(
        ...
        // // Strategy10(crvUSD+USDC.e)
        // ConvexUSDCCrvUSDStrategy implementation10 = new ConvexUSDCCrvUSDStrategy();
        // _proxy = new TransparentUpgradeableProxy(
        ...
        //         address(vaultUsdce),
        //         keepers,
        //         bytes32(abi.encode("MaxApy Curve Strategy")),
        //         strategyAdmin,
        ...
        // // Strategy11(crvUSD+USDT)
        // ConvexUSDTCrvUSDStrategy implementation11 = new ConvexUSDTCrvUSDStrategy();
        // _proxy = new TransparentUpgradeableProxy(
        ...
        // console2.log("[YEARN] YearnDAIStrategy:", address(strategy7));
        // console2.log("[YEARN] YearnDAILenderStrategy:", address(strategy8));
        // console2.log("[BEEFY] BeefyMaiUSDCeStrategy:", address(strategy9));
        // console2.log("[CONVEX] ConvexUSDCCrvUSDStrategy:", address(strategy10));
        // console2.log("[CONVEX] ConvexUSDTCrvUSDStrategy:", address(strategy11));
    ...
    function setUpProtocol(address deployerAddress) internal {
        ...
        for (uint256 i = 0; i < pks.length - 1; i++) {
